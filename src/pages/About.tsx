      ...
      <div className="space-y-8">
        <div className="card-elevated p-8 border-l-4 border-blue-500">
          ...
          <ul className="space-y-4 text-gray-600 dark:text-gray-300">
            <li className="flex items-start gap-4 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
              <span className="text-3xl flex-shrink-0">⚛️</span>
              <div>
                <strong className="text-lg text-gray-900 dark:text-white">React 18</strong>
            ...
            <li className="flex items-start gap-4 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
              ...
              <div>
                <strong className="text-lg text-gray-900 dark:text-white">Vite</strong>
            ...
            <li className="flex items-start gap-4 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
              <span className="text-3xl flex-shrink-0">📘</span>
              <div>
                <strong className="text-lg text-gray-900 dark:text-white">TypeScript</strong>
            ...
            <li className="flex items-start gap-4 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
              <span className="text-3xl flex-shrink-0">🎨</span>
              <div>
                <strong className="text-lg text-gray-900 dark:text-white">Tailwind CSS</strong>
            ...
            <li className="flex items-start gap-4 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
              <span className="text-3xl flex-shrink-0">🚦</span>
              <div>
                <strong className="text-lg text-gray-900 dark:text-white">React Router</strong>
        ...
        <div className="card-elevated p-8 border-l-4 border-purple-500 bg-gradient-to-br from-purple-50/50 to-blue-50/50 dark:from-purple-900/20 dark:to-blue-900/20">
          <h2 className="text-3xl font-bold mb-6 flex items-center gap-3">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="flex items-center gap-3 p-3 rounded-lg bg-white dark:bg-gray-800 shadow-sm">
              ...
              <span className="text-gray-700 dark:text-gray-300">Fast development with HMR</span>
            </div>
            <div className="flex items-center gap-3 p-3 rounded-lg bg-white dark:bg-gray-800 shadow-sm">
              <span className="text-2xl">🔒</span>
              <span className="text-gray-700 dark:text-gray-300">Type-safe code with TypeScript</span>
            </div>
            <div className="flex items-center gap-3 p-3 rounded-lg bg-white dark:bg-gray-800 shadow-sm">
              <span className="text-2xl">🎨</span>
              <span className="text-gray-700 dark:text-gray-300">Modern UI with Tailwind CSS</span>
            </div>
            <div className="flex items-center gap-3 p-3 rounded-lg bg-white dark:bg-gray-800 shadow-sm">
              <span className="text-2xl">🚀</span>
              <span className="text-gray-700 dark:text-gray-300">Optimized production builds</span>
            </div>
            <div className="flex items-center gap-3 p-3 rounded-lg bg-white dark:bg-gray-800 shadow-sm">
              <span className="text-2xl">🌐</span>
              <span className="text-gray-700 dark:text-gray-300">Client-side routing</span>
            </div>
            <div className="flex items-center gap-3 p-3 rounded-lg bg-white dark:bg-gray-800 shadow-sm">
              <span className="text-2xl">📦</span>
